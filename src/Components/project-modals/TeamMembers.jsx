...
const TeamMembers = ({ teamDetails, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-[#1a1a1a] p-8 rounded-[2.5rem] shadow-2xl w-full max-w-4xl relative overflow-hidden transition-colors"> 
        <button 
          onClick={onClose}
        ...
        <header className="mb-8">
          <div className="flex items-center gap-3 text-orange-600 mb-2">
            ...
            <h3 className="text-xs font-black uppercase tracking-[3px]">Collaboration Unit</h3>
          </div>
