...
const Header = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/70 dark:bg-[#000000]/70 backdrop-blur-md border-b border-gray-200 dark:border-[#1a1a1a]">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-6">
            <button 
              ...
              className="p-2.5 rounded-xl bg-gray-50 dark:bg-[#151515] text-gray-600 dark:text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-600/10 transition-all border border-transparent dark:border-[#1a1a1a]"
