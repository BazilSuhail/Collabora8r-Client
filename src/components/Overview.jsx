...
const Overview = () => {
  ...
  return (
    <div className='min-h-screen bg-[#fcfaf8] dark:bg-[#000000] flex flex-col p-5 transition-colors duration-300'>
      <div className="flex sm:flex-row flex-col sm:justify-between sm:items-center">
        <div className="flex items-center space-x-2">
          <GiProgression className="text-2xl text-gray-600 dark:text-gray-400" />
          <h2 className="text-[24px] text-gray-600 dark:text-gray-300 font-bold">Progress Overview</h2>
      ...
      <p className='mt-[2px] text-[13px] lg:ml-[35px] mb-[15px] font-[500] text-gray-500 dark:text-gray-400'>
        View statistics and visual overview of all your progress made at one place.
      </p>

      <div className='h-[1px] mb-[15px] w-full bg-gray-200 dark:bg-[#1a1a1a]'></div>

      <div className='grid overflow-hidden grid-cols-2 mb-[20px] bg-white dark:bg-[#0a0a0a] p-4 rounded-2xl border border-gray-100 dark:border-[#1a1a1a] shadow-sm place-items-center gap-2 lg:grid-cols-3'>
        <motion.div
          initial={{ x: -100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.5 }}
          className='bg-gray-50 dark:bg-[#151515] border border-gray-100 dark:border-[#1a1a1a] rounded-xl text-white p-[15px] w-full flex flex-row transition-colors'>
        ...
        <motion.div
          ...
          <div className='ml-[15px]'>
            ...
            <p className='font-medium text-gray-600 dark:text-gray-300 text-[18px] md:text-[22px]'>{projectsCount.managerProjectCount}</p>
          </div>
        </motion.div>
      ...
      <div className='grid gap-[15px] grid-cols-1 lg:grid-cols-2'>
        <div className='flex flex-col py-[12px] bg-white dark:bg-[#0a0a0a] rounded-xl border border-gray-100 dark:border-[#1a1a1a] shadow-sm'>
