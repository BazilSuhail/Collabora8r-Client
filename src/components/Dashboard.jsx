...
const Dashboard = () => {
  ...
  */
  return (
    <main className="min-h-screen bg-white dark:bg-[#000000] py-6 px-3 sm:p-6 transition-colors duration-300">
      ...
      <section className='grid grid-cols-1 xl:grid-cols-7  xsx:grid-rows-1'>
        <div className='col-span-1 xl:col-span-2 mb-[15px] xsx:mx-[8px]'>
          ...
          <div className='xsx:mx-[5px] border-[2px] border-gray-100 dark:border-[#1a1a1a] pl-[15px] py-[20px] w-full rounded-xl bg-white dark:bg-[#0a0a0a] shadow-sm'>
            <div className="mb-[12px]  flex items-center text-gray-700 dark:text-gray-300 lg:text-[18px]">
              <FaCalendar className="bg-orange-500 mr-[5px] lg:mr-[10px] text-white rounded-xl p-2 text-[24px] lg:text-[28px]" />
              <span>Scheduled: </span>
            ...
            <div className="mb-[12px] flex items-center text-gray-700 dark:text-gray-300 lg:text-[18px]">
              <FaRunning className="bg-orange-600 mr-[5px] lg:mr-[10px] text-white rounded-xl p-2 text-[24px] lg:text-[28px]" />
              <span>In Progress: </span>
              <span className="font-semibold text-lg lg:text-[19px] ml-[8px]">
                {statusCounts['In Progress']}
              </span>
            </div>
            <div className="flex items-center text-gray-700 dark:text-gray-300 lg:text-[18px]">
              <ImCross className="bg-green-600 mr-[5px] lg:mr-[10px] text-white rounded-xl p-2 text-[24px] lg:text-[28px]" />
              <span>Completed: </span>
              <span className="font-semibold text-lg lg:text-[19px] ml-[8px]">
            ...
            {filteredTasks.length > 0 ? (
              filteredTasks.map((task) => (
                <div
                  ...
                  key={task._id}
                  className="px-4 pt-4 pb-2 bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-[#1a1a1a] rounded-xl transform transition duration-300 hover:scale-[1.01] hover:shadow-lg shadow-sm"
                >
                  <div className='flex xsx:flex-row flex-col xsx:items-center xsx:justify-between'>
                    <h1 className="text-[17px] xsx:text-[19px] flex items-center font-bold text-gray-800 dark:text-white">
                      <span className='bg-orange-100 dark:bg-orange-500/10 p-2 rounded-lg'>
                        <FaClipboardList className='text-orange-600 text-[18px] xsx:text-[20px]' />
                      </span>
                      <span className='ml-3'>{task.title.slice(0, 48)} {task.title.length > 48 && '...'}</span>
                    </h1>
