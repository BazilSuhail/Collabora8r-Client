    ...
    <main className="min-h-screen bg-[#fcfaf8] dark:bg-[#000000] p-4 lg:p-6 transition-colors duration-300">
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-7 gap-8 pt-4">
        ...
        <section className='lg:col-span-5 flex flex-col gap-6 order-2 lg:order-1'>
          {/* Directive Header */}
          <div className='bg-white dark:bg-[#0a0a0a] p-6 lg:p-8 border border-gray-100 dark:border-[#1a1a1a] rounded-3xl shadow-sm'>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              ...
              <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-start gap-2">
                <span className={`px-3 lg:px-4 py-1 rounded-full text-[9px] lg:text-[10px] font-black uppercase tracking-[2px] ${
...
<div className='flex items-center justify-between'>
   <div className='flex items-center gap-2 mt-1'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 border-t border-gray-50 dark:border-[#1a1a1a]">
              ...
              <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-[#151515] rounded-2xl border border-transparent">
                ...
                <div>
                  ...
                  <p className="font-black text-sm lg:text-base text-gray-800 dark:text-white uppercase">{task.status}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='bg-white dark:bg-[#0a0a0a] p-6 lg:p-8 border border-gray-100 dark:border-[#1a1a1a] rounded-3xl shadow-sm'>
            ...
            <p className="text-sm lg:text-base text-gray-600 dark:text-gray-400 leading-relaxed lg:pl-8 border-l-2 border-orange-500/10 italic">
              {task.description}
            </p>
          </div>

          {/* Operational Logs (Comments) */}
          <div className='bg-white dark:bg-[#0a0a0a] p-6 lg:p-8 border border-gray-100 dark:border-[#1a1a1a] rounded-3xl shadow-sm flex-1'>
        ...
        <section className='lg:col-span-2 flex flex-col gap-6 order-1 lg:order-2'>
          {/* Progress Visualizer */}
          <div className="p-6 lg:p-8 bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-[#1a1a1a] rounded-3xl shadow-sm text-center">
            ...
            <div className={`py-2 px-4 rounded-xl text-[9px] lg:text-[10px] font-black uppercase tracking-[2.5px] mb-6 shadow-inner ${
            ...
            {task.assignedTo === user._id && (
              <button 
                onClick={toggleModal} 
                className="w-full bg-white dark:bg-[#0a0a0a] text-orange-600 border-2 border-orange-600 py-3 lg:py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-orange-600 hover:text-white transition-all shadow-sm active:scale-95"
              >
          ...
          {/* Comment Transceiver */}
          <div className="p-6 lg:p-8 bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-[#1a1a1a] rounded-3xl shadow-sm">
            <div className="flex items-center gap-3 text-orange-600 mb-6">
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm z-[1000]">
            <motion.div
              ...
              className="bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-[#1a1a1a] rounded-3xl shadow-2xl w-full max-w-md p-6 lg:p-8 relative"
            >
              ...
              <header className="mb-8">
                ...
                <p className="text-[10px] lg:text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mt-1">Re-evaluating operational metrics.</p>
              </header>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <div className='flex items-center justify-between'>
                    <label className="flex items-center gap-2 text-[10px] lg:text-xs font-black uppercase tracking-widest text-gray-400">
